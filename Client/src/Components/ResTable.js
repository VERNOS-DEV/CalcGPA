    ...
    <div className="container_table">
      <div className="detail_cont">
        ...
        <table className="res-table" border={0}>
            ...
            <thead>
                <tr>
                    <th scope="col" colSpan='2' id="th">Subjects</th>
            ...
            <tbody>
                {subjects.map((subject, index) => (
                    <tr key={index}>
                        <td colSpan={2} id="sub">{subject.subjectName}</td>
                        <td id="cre">{subject.credit}</td>
                        <td id="marks">{marks[index]}</td>
                        <td id="grade">{obtainedCredit[index]}</td>
                    </tr>
          ))}
          <tr className="empty res">
          </tr>
          <tr className="res">
            <td colSpan={3} className="tm">Total Marks </td>
            <td className="tm">{totalMarks}</td>
            <td className="tm">{obtainedCredit.reduce((acc,cre)=>acc+cre,0)}</td>
          </tr>
          <tr className="res">
            <td colSpan={3} className="tm">SGPA</td>
            <td colSpan={2} className="tm">{sgpa}</td>
          </tr>
